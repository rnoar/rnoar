...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      content: 'ВРНОАР - Воронежское региональное отделение Общероссийской общественной организации «Российское научное общество анализа риска». \
        ВРНОАР осуществляет консультационную деятельность по вопросам анализа и управления риском. \
